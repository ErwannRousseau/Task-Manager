...
const categoryDisplay = {
  ...
  insertCategoryInDom(category) {
    ...
    document.querySelector('.task-edit-form__category').appendChild(categorySelectCreate);
    document.querySelector('.form__select-category').appendChild(categorySelectUpdate);
  },
};
